...
//panggil data tagihan hari ini
	function get_id_tagihan() {
$tgl = date('Y-m-d');
$this->db->like('tgl_angsuran', $tgl);
return $this->db->get('v_hitung_pinjaman')->result_array();
}
	...
	function get_semua_denda_by_pinjaman($master_id) {
		...
		$tgl_tempoo = date('Y-m-d', strtotime("+".$ags_ke." weeks", strtotime($tgl_pinjam)));
		$tgl_tempo = date('Y-m-d', strtotime("+".$ags_ke." weeks", strtotime($tgl_tempoo)));
