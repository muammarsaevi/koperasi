	...
	function cetak($id) {
		...
		<table width="100%" cellspacing="0" cellpadding="3" border="1" border-collapse= "collapse">';
			...
			<tr>
				<td> Lama Pinjam </td>
				<td> : </td>
				<td> '.$row->lama_angsuran.' Kali /2 Minggu</td>
			</tr>';
			$html .= '</table>';
		...
		$html .= '<br><br><table width="100%" cellspacing="0" cellpadding="3" border="1" border-collapse= "collapse">
			<tr class="header_kolom">
				<th style="width:7%;"> Bln ke</th>
				<th style="width:10%;"> Angsuran Pokok</th>
				<th style="width:10%;"> Margin</th>
				<th style="width: 6%;"> Biaya Adm</th>
				<th style="width: 7%;"> Biaya Provisi</th>
				<th style="width:10%;"> Jumlah Angsuran</th>
				<th style="width:15%;"> Tanggal Tempo</th>
				<th style="width:15%;"> Tanggal Angsuran</th>
				<th style="width:20%;"> Paraf Petugas</th>
			</tr>';
		...
		if(!empty($simulasi_tagihan)) {
			...
			foreach ($simulasi_tagihan as $row) {
				...
				$html .= '
					<tr>
						...
						<td class="h_tengah">'.number_format(nsi_round($row['biaya_adm'])).'</td>
						<td class="h_tengah">'.number_format(nsi_round($row['provisi_pinjaman'])).'</td>
			...
			$html .= '<tr bgcolor="#eee">
						...
						<td class="h_tengah"><strong>'.number_format(nsi_round($jml_adm)).'</strong></td>
						<td class="h_tengah"><strong>'.number_format(nsi_round($jml_provisi)).'</strong></td>
