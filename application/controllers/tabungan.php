...
class Tabungan extends OperatorController {
	...
	public function index() {
		...
		$config["total_rows"] = $this->tabungan_m->get_jml_data_simpan(); // banyak data
		$config["per_page"] = 10;
		...
		$this->data["data_anggota"] = $this->tabungan_m->get_data_anggota($config["per_page"], $offset); // panggil seluruh data aanggota
		$this->data["halaman"] = $this->pagination->create_links();
		$this->data["offset"] = $offset;

		$this->data["data_jns_simpanan"] = $this->tabungan_m->get_jenis_simpan(); // panggil seluruh data simpanan
