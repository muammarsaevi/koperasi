	...
	<div class="box box-solid bg-light-blue">
		<table width="100%" style="font-size: 12px;">
			<tr>
				...
				<td> Sisa Angsuran : <span id="det_sisa_ags"> <?php echo $row_pinjam->lama_angsuran - $sisa_ags; ?> </span> angsuran </td>
...
<table  class="table table-bordered">
	<tr class="header_kolom">
		<th style="width:10%; vertical-align: middle"> Angsuran  ke</th>
		<th style="width:15%; vertical-align: middle"> Angsuran Pokok</th>
		<th style="width:15%; vertical-align: middle"> Angsuran Margin</th>
		<th style="width:15%; vertical-align: middle"> Biaya Adm</th>
		<th style="width:15%; vertical-align: middle"> Biaya Provisi</th>
		<th style="width:15%; vertical-align: middle"> Jumlah Angsuran</th>
		<th style="width:30%; vertical-align: middle"> Tanggal Tempo</th>
	</tr>
