...
<table  class="table table-bordered">
	...
	<tr>
		...
		<td> Pendapatan Biaya Margin Sampai Lunas</td>
		<td class="h_kanan">
			<?php
...
<table  class="table table-bordered">
	...
	<tr>
		<td class="h_tengah"> 3 </td>
		<td> Pendapatan Margin Pinjaman</td>
		<td class="h_kanan">
			<?php
				$sbunga = $sbunga->jml_total; 
				echo ''.number_format(nsi_round($sbunga)).'<br>';
			?>
		</td>
	</tr>
	...
	<tr class="header_kolom">
		...
		<td class="h_kanan"><?php $jml_p =$sbunga + $jml_dapat;
