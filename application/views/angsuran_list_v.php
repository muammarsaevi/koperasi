...
<div class="box box-solid box-primary">
			...
			<tr>
				...
				<td>
					...
					<tr>
						<td> Lama Pinjaman</td> 
						<td> : </td>
						<td> <?php echo $row_pinjam->lama_angsuran; ?> Periode /2 Minggu</span></td>
					</tr>
					</table>
				</td>
				<td>
	...
	<table width="100%" style="font-size: 17px;">
		<tr>
			...
			<td> Sisa Angsuran : <span id="det_sisa_ags"> <?php echo $row_pinjam->lama_angsuran - $sisa_ags; ?> </span> X Angsuran </td>
...
<div id="alur" class="easyui-dialog" show= "blind" hide= "blind" modal="true" resizable="false" style="width:500px; height:385px; padding-top: 10px" closed="true" style="display: none;">
	...
	<table>
		...
		<tr>
			<td></td>
			<td valign="top"> - </td>
			<td> Batas maksimal pembayaran Sesuai Jatuh Tempo, <code>Tanggal Dapat diubah pada menu Setting &raquo; Suku Bunga</code></td>
		</tr>
		<tr>
