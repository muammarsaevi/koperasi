...
<thead>
	<tr>
		...
		<th data-options="field:'id_txt', width:'12',halign:'center', align:'center'">Kode</th>
		<th data-options="field:'tgl_pinjam_txt', width:'20', halign:'center', align:'center'">Tanggal Pinjam</th>
		<th data-options="field:'status', width:'20', halign:'center', align:'center'">Tanggal Tagihan</th>
		<th data-options="field:'anggota_id', width:'14', halign:'center', align:'center'">ID Anggota</th>
		<th data-options="field:'anggota_id_txt', width:'20', halign:'center', align:'left'">Nama Anggota</th>
		...
		<th data-options="field:'bunga', width:'15', halign:'center', align:'right'">Margin <br> Angsuran</th>
		<th data-options="field:'biaya_adm', width:'10', halign:'center', align:'right'">Biaya <br> Admin </th>
		<th data-options="field:'angsur_ke', width:'14', halign:'center', align:'center'">Sudah <br> Bayar</th>
		<th data-options="field:'angsuran_bln', width:'15', halign:'center', align:'center'">Angsuran <br> Per Bulan</th> 
		<th data-options="field:'bayar', halign:'center', align:'center'">Menu <br> Bayar </th>
	</tr>
</thead>
</table>
...
function fm_filter_tgl() {
	$('#daterange-btn').daterangepicker({
		ranges: {
			...
			'7 Hari yang lalu': [moment().subtract('days', 14), moment()],
