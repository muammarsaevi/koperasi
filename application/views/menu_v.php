...
<li  class="treeview <?php
	...
	<?php } ?>
		...
		<li class="<?php if ($this->uri->segment(1) == 'tabungan' || $this->uri->segment(1) == 'tabungan') { echo 'active'; } ?>"><a href="<?php echo base_url(); ?>tabungan"> <i class="fa fa-folder-open-o"></i> Tabungan</a></li>
	...
	<?php if($level != 'pinjaman') { ?>
		...
		<!-- BuatanSendiri -->
		<li class="<?php if ($this->uri->segment(1) == 'lap_tagihan') { echo 'active'; } ?>"> <a href="<?php echo base_url(); ?>lap_tagihan"><i class="fa fa-folder-open-o"></i> Tagihan  Hari Ini</a></li>
...
<ul class="treeview-menu">
	...
	<li class="<?php if ($this->uri->segment(1) == 'suku_bunga') { echo 'active'; } ?>">  <a href="<?php echo base_url(); ?>suku_bunga"> <i class="fa fa-folder-open-o"></i> Suku Bunga </a></li>
	 ...
	 <li class="">  <a href="http://localhost/phpmyadmin/server_export.php"> <i class="fa fa-folder-open-o"></i> Backup Database </a></li>
